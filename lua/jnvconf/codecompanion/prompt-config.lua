local providers = require("jnvconf.codecompanion.providers")
local ui_utils = require("jnvconf.codecompanion.utils.ui")
...
M.setup = function(args)
	...
	if args.interactions and args.interactions.chat and args.interactions.chat.editor_context then
		M.config.interactions.shared.editor_context = vim.tbl_deep_extend(
			"force",
			M.config.interactions.shared.editor_context,
			args.interactions.chat.editor_context
		)
