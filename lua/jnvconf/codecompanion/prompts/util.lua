...
local prompts_dir = (vim.api.nvim_get_runtime_file("lua/jnvconf/codecompanion/prompts/", false))[1]
	or vim.notify("Prompts directory not found", vim.log.levels.ERROR)
