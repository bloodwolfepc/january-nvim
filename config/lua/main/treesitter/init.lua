...
local keymaps = {
	...
	-- 	mode = { "n" },
	-- 	builder = function(p)
	-- 		return { require("nvim-treesitter.incremental_selection")()[p](), { desc = "TS: " .. p } }
	-- 	end,
	-- 	keys = {
	-- 		["<leader>"] = {
	-- 			s = {
	...
	{
		mode = { "n" },
		-- p is { "swap_next", @parameter.inner" }
		-- i get error: attempt to call a table value
		builder = function(p)
			return {
				require("nvim-treesitter-textobjects.move")()[p[1]](p[2]),
				{ desc = "TSTO Swap: " .. p[1] .. p[2] },
			}
		end,
		keys = {
